<div class="navbar my-navbar" role="navigation" aria-labelledby="navbar-header">
        <div id="navbar-header">
          ...
          <span class="icon-search"><img src="https://wrdsb-ui-assets.s3.amazonaws.com/<?php echo $GLOBALS['wrdsbvars']['asset_version']; ?>/images/search.gif" style="width: 25px; height: 25px;" /></span>
          </button>
