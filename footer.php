        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-md-3">
                ...
                <ul>
                    ...
                    <li><a id="footer-link-help-desk" target="_blank" href="https://itservicedesk.wrdsb.ca/">ITService Desk (Help Desk)</a></li>
                </ul>
            </div>
        ...
        <div class="row">
            <div class="col-sm-6 col-md-3">
                ...
                <ul>
                    ...
                    <li><a id="footer-link-trillium-guide" href="https://staff.wrdsb.ca/trillium/"><img src="https://staff.wrdsb.ca/wp-content/uploads/2021/07/streamline-icon-bookmarks-document@48x48.png" class="guide-icon" alt="WRDSB Product Guide" />Trillium Guide</a></li>
                    <li><a id="footer-link-twea" target="_blank" href="https://etrillium.wrdsb.ca/trillium/">TWEA</a></li>
                    <li><a id="footer-link-twea-guide" href="https://staff.wrdsb.ca/twea/"><img src="https://staff.wrdsb.ca/wp-content/uploads/2021/07/streamline-icon-bookmarks-document@48x48.png" class="guide-icon" alt="WRDSB Product Guide" />TWEA</a></li>
            ...
            <div class="col-sm-6 col-md-3">
                ...
                <ul>
                    ...
                    <li><a id="footer-link-class-lists" href="<?php echo get_site_url(); ?>/trillium/classes">Class lists</a></li>
                    <?php } ?>
                    <?php if (wrdsb_get_school_code()) { ?>
                    <li><a id="footer-link-device-tracking" href="<?php echo get_site_url(); ?>/quartermaster/device-loans/all">LFH Device Tracking</a></li>
                    <?php } ?>
                    <li><a id="footer-link-mental-health" target="_blank" href="/mental-health/"><img src="https://staff.wrdsb.ca/wp-content/uploads/2021/07/streamline-icon-bookmarks-document@48x48.png" class="guide-icon" alt="WRDSB Product Guide" />Mental Health</a></li>
            ...
            <div class="col-sm-6 col-md-3">
                ...
                <ul>
                    <li><a id="footer-link-equity" href="https://staff.wrdsb.ca/indigenous-equity-human-rights/equity-and-inclusion/">Equity and Inclusion</a></li>
                    ...
                    <li><a id="footer-link-prolearn-guide" href="https://staff.wrdsb.ca/prolearn/"><img src="https://staff.wrdsb.ca/wp-content/uploads/2021/07/streamline-icon-bookmarks-document@48x48.png" class="guide-icon" alt="WRDSB Product Guide" />ProLearn Guide</a></li>
